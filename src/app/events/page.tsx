...
import { CalendarHeart, MapPin, Users, Clock, CheckCircle2, Hourglass, XCircle } from 'lucide-react';
            ...
            {myTasks.map((t) => (
              <div key={t.id} className="py-3 flex items-center justify-between text-xs">
                <div className="min-w-0">
                  ...
                  <span className="text-[10px] text-slate-400">{t.role} • {formatDate(t.createdAt)}</span>
                </div>
